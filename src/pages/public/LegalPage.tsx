...
const documents: Record<LegalPageType, LegalDocument> = {
  terms: {
    ...
    summary: 'These Terms govern access to the Shri Tripura Sundari Lalithambe Trust website, devotee accounts, seva bookings, memberships, event registrations and related digital services.',
    sections: [
      ...
      { title: '5. Memberships', paragraphs: ['Membership benefits are subject to the selected plan, eligibility, availability and applicable Trust rules. Membership does not create ownership, employment, agency or voting rights unless separately granted in writing.'] },
  ...
  'payment-terms': {
    title: 'Payment Terms',
    eyebrow: 'Bookings and memberships',
    summary: 'These Payment Terms apply to seva bookings, event fees, memberships and other amounts paid through this website.',
    sections: [
      ...
      { title: '3. Confirmation', paragraphs: ['A payment is complete only after successful verification. A bank debit, pending message or payment screenshot alone does not confirm a booking or membership. Keep the transaction reference and wait for the website or Trust confirmation. Contact support if your account is debited but no confirmation is received.'] },
