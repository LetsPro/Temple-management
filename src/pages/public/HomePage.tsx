    ...
    <div className="temple-home">
      ...
      <section className="guru-home-section">
        <div className="page-container guru-home-grid">
          <div className="guru-home-image"><img src="/sadguru-sri-satish-guruji.jpg" alt="Sri Satish Guruji" loading="eager" /></div>
          <div className="guru-home-copy">
            <span>Spiritual guide</span>
            <h2>Sri Satish Guruji</h2>
            <p>Sri Satish Guruji is a renowned Yoga Master, spiritual guide and ardent devotee of Supreme Mother Sri Lalitha Tripura Sundari. Introduced to yoga by his father at the age of five, he became a Guru at sixteen and has since guided thousands through yoga, naturopathy, Tantra, Vedic Astrology, Astro-Yoga and Vasthu Shastra.</p>
            <Link to="/about#guru-profile" className="btn-primary">Read More <ArrowRight size={16} /></Link>
          </div>
        </div>
      </section>
