              ...
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    ...
                    {event.is_published ? (
                      <span className="text-xs bg-green-50 text-green-700 border border-green-200 px-2 py-0.5 rounded-full font-semibold">Published</span>
                    ) : (
                      <span className="text-xs bg-stone-100 text-stone-700 px-2 py-0.5 rounded-full">Draft</span>
                    )}
