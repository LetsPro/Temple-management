...
Upserts the three public membership plans (Annual, Half-Yearly, Quarterly
Patron) and recreates the RLS policies:
  - membership_plans_public_read: anon + authenticated SELECT active plans;
    admins see all.
  - membership_plans_admin_write: admins only, all CRUD.

## Plans
- Annual Patron:      ₹3511, 12 months, display_order 1
- Half-Yearly Patron: ₹2511,  6 months, display_order 2
- Quarterly Patron:   ₹1611,  3 months, display_order 3

## Approach
1. UPDATE existing rows by name (amount, duration, benefits, active,
   display_order, updated_at).
2. INSERT any of the three plans that do not yet exist.
3. Ensure RLS is enabled.
4. Recreate the two policies (DROP IF EXISTS first).
*/
